...
export const Modal = ({ isOpen, onClose, title, children, maxWidth = 'max-w-xl' }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] !m-0 flex items-center justify-center p-3 sm:p-4 md:p-6 bg-slate-950/85 backdrop-blur-md animate-fade-in overflow-y-auto">
